...
public class Aims {
    ...
    public static void initSetup() {
        DigitalVideoDiscTienLC dvd1 = new DigitalVideoDiscTienLC("The Lion King", "Animation", "Roger Allers", 87, 19.95f);     
        DigitalVideoDiscTienLC dvd2 = new DigitalVideoDiscTienLC("Star War", "Science Fiction", "George Lucas", 87, 24.95f); 
        DigitalVideoDiscTienLC dvd3 = new DigitalVideoDiscTienLC("Aladin", "Animation", 18.99f);
        store.addMedia(dvd1);
        store.addMedia(dvd2);
        store.addMedia(dvd3);
        ...
        BookTienLC book2 = new BookTienLC("On the Origin of Time: Stephen Hawking's Final Theory", "Science", 120.00f);
        store.addMedia(book);
        store.addMedia(book1);
        store.addMedia(book2);

        CompactDiscTienLC cd1 = new CompactDiscTienLC("Adele - 30", "Music","Adele", 1500.98f);
        TrackTienLC track1CD1 = new TrackTienLC("All Night Parking (interlude)", 161);
        TrackTienLC track2CD1 = new TrackTienLC("To Be Loved", 403);
        TrackTienLC track3CD1 = new TrackTienLC("Woman Like Me", 300);
        cd1.addTrack(track1CD1);
        cd1.addTrack(track2CD1);
        cd1.addTrack(track3CD1);

        CompactDiscTienLC cd2 = new CompactDiscTienLC("Master D", "Music","Quang Hung Master D", 2000.22f);
        TrackTienLC track1CD2 = new TrackTienLC("Thuy trieu", 180+34);
        TrackTienLC track2CD2 = new TrackTienLC("Troi em lai", 180+30);
        TrackTienLC track3CD2 = new TrackTienLC("De den de di", 60*2+39);
        cd2.addTrack(track1CD2);
        cd2.addTrack(track2CD2);
        cd2.addTrack(track3CD2);

        CompactDiscTienLC cd3 = new CompactDiscTienLC("Purpose", "Music","Justin Bieber", 1000.98f);
        TrackTienLC track1CD3 = new TrackTienLC("The Feeling", 4*60+5);
        TrackTienLC track2CD3 = new TrackTienLC("No Sense", 4*60+35);
            ...
            switch (option) {
                ...
                case 1:
                    ...
                    while (!foundDetails) {
                        ...
                        MediaTienLC media = store.search(title);
                        if (media != null) {
                            clearConsole();
                ...
                case 3:
                    ...
                    while (!foundToPlay) {
                        ...
                        MediaTienLC media = store.search(title);
                        if (media != null) {
                            if (media instanceof DiscTienLC || media instanceof CompactDiscTienLC) {
                                media.play();
                            } else {
    ...
    public static void mediaDetailsMenu(Scanner scanner, MediaTienLC media) {
        boolean back = false;
        while (!back) {
            System.out.println("Options: ");
            System.out.println("--------------------------------");
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    while (!foundToRemove) {
                        ...
                        MediaTienLC media = cart.searchToRemove(title);
                        if (media != null) {
                            clearConsole();
            ...
            switch (option) {
                ...
                case 1:
                    ...
                    if (categoryChoice == 1) {
                        ...
                        BookTienLC newBook = new BookTienLC(bookTitle, bookCategory, bookCost);
                        ...
                        CompactDiscTienLC newCD = new CompactDiscTienLC(cdTitle, cdCategory, cdArtist, cdCost);
                        ...
                        if (addTrack == 1) {
                            ...
                            for (int i = 0; i < numTrack; i++) {
                                ...
                                TrackTienLC newTrack = new TrackTienLC(trackTitle, trackLength);
                        ...
                        DigitalVideoDiscTienLC newDVD = new DigitalVideoDiscTienLC(dvdTitle, dvdCategory, dvdCost);
                ...
                case 2:
                    ...
                    while (!foundToRemove) {
                        ...
                        MediaTienLC media = store.search(titleForRemove);
                        if (media != null) {
                            clearConsole();
