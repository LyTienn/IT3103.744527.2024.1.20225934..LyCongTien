...
public class AddDVDScreenController {
    ...
    public AddDVDScreenController(StoreTienLc store) {
        super();
        this.store = store;
    }
    ...
    void btnSavePressed(ActionEvent event) {
        ...
        DigitalVideoDiscTienLC DVD = new DigitalVideoDiscTienLC(title, category, director, length, cost);
        store.addMedia(DVD);
        tfTitle.clear();
        tfCategory.clear();
        tfDirector.clear();
